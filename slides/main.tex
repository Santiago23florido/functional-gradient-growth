...
\input{sections/20_adaptive_representations}
\input{sections/30_cage_nas_overview}
\input{sections/31_damped_tangent_family}
\input{sections/32_nonlinear_displacement_family}
\input{sections/33_where_to_grow}
\input{sections/40_results_controlled_benchmark}
\input{sections/41_results_search_quality}
\input{sections/42_results_fixed_retraining}
\input{sections/43_results_scalability}
\input{sections/90_conclusions}
